...
<div class="box-header" >
  ...
  <td width="18%" align="center">
        Filter-By:<select name="filterentry"  id="filterentry" onchange="filterView('<?php echo $pager_pageIndex;  ?>','<?php echo $pagelimit; ?>','<?php echo $searchTextMatch;?>');" style="text-transform: uppercase !important;">
        <option data-filter="article.portfolio" href="#">Categories</option>
        <option data-filter="article.portfolio[data-category~='illustration']" href="#">Events</option>
         <option data-filter="article.portfolio[data-category~='photography']" href="#">Entertainment</option>
          <option data-filter="article.portfolio[data-category~='branding']" href="#">Weddings</option>
           <option data-filter="article.portfolio[data-category~='video']" href="#">Video</option>
        </select>
  </td>
