...
<?php if(in_array(2, $UserRight)){ ?>   
  <button type="button" name="save_priority" data-dismiss="modal2"  class="btn btn-primary center-block" onclick="UpdateCategoryPriority('<?php echo $getpageindex; ?>','<?php echo $limitval; ?>');">Save Priority</button>
<?php } else { ?>
<button type="button" disabled name="save_priority" data-dismiss="modal2" class="btn btn-primary center-block">Changes Priority</button>
<?php } ?> 
