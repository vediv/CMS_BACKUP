...
<style type="text/javascript">
	.col-md-4{ min-height: 44px; }
</style>
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h4 class="modal-title">Export Registered Users List</h4>
</div>
<div class="modal-body" style="border: 0px solid red; height: 220px; ">
  <div class="box">
    ...
    <form name="myForm" action="operation.php?action=userlist" method="post" onsubmit="return downloadUserList()">     
...
function downloadpdf()
{
        ...
        if(mypdf==".pdf")
        {
          window.open("operation.php?action=userListPdf&fromDate="+fromDate+"&toDate="+toDate,'_blank');    
