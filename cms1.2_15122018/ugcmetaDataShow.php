...
//$video_path="video/data/biocine_ott503/video_download/PMSLIMG264DXM8RV..mp4";
$video_path="http://cdnbiocine.planetcast.in/biocine/content/0_v054ov82/a.m3u8";
$userID=$get_user_id;
...
<button type="button" class="btn btn-primary btn1"  disabled  id="save_button" name="submit" style="margin-left: 130px; margin-top: -80px;"  onclick="save_ugcmetedata_in_server('saveClose','<?php echo $Entryid; ?>','<?php echo $getpageindex;  ?>','<?php echo $limitval;  ?>');" >Save</button>
<button type="button" class="btn btn-danger btn1"   id="reject" name="submit"  style=" margin-top: -80px;" onclick="ugcRegect('ugc_regect','<?php echo $Entryid; ?>','<?php echo $getpageindex;  ?>','<?php echo $limitval;  ?>')">Reject</button>
...
<div class="pull-right" id="drawVideoPlayer11"  style="border:0px solid black ; width: 40%; margin-right: 30px; padding:5px; height: 305px !important;">
    ...
    <div id="fp-dash" class="is-closeable" style="margin-top: 55px;"><img src="img/pause-push-2.gif" alt="Video Not Found" height="100%" width="100%"></img></div>  
