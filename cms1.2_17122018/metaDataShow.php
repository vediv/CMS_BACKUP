...
<div class="row" style="border: 0px solid red; margin-top: 5px;">
 <div class="pull-left" style=" border:0px solid #c7d1dd ; border-top:0px ; width: 55%; margin-left: 10px;">
    ...
    <div class="form-group">
        ...
        <span class="help-block has-error" id="input-category-error" style="color:red;"></span>
        </div>  
...
function save_metedata_in_server(smatadata,entryid,pageindex,limitval){
    ...
    var metadata_category_get = document.getElementsByName('metadata_category[]');
    var mlength=metadata_category_get.length;
    if(mlength == '0')
    {	    		    	
        var message="Category  should not be blank";
        $("#input-category-error").html(message);
