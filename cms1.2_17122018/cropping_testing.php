...
<div id=show_image1>
    <script>
        var img;
			...
			<!-- Related demos -->
			<div>
			<button id="edit" class="btn-edit" onClick="edit();">Edit</button>
                        <button id="save" class="btn-edit" onClick="save();">save</button>
			<button id="click" class="btn-crop js-crop">Crop<img class="icon-crop" src="img/crop.svg"></button>
</div>
		</div> <!-- /container -->
...
var resizeableImage = function(image_target) {
  ...
  crop = function(){
	...
	var show_image= '<img src="'+crop_canvas.toDataURL("image/png")+'">';

       $("#show").hide();
 	$("#show_image1").show();
	document.getElementById("show_image1").innerHTML=show_image;
var x = crop_canvas.toDataURL("image/png");
  }
