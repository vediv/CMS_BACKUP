               ...
               ?>
                ...
                <div class="panel-body">
                 <div class="form-inline">   
                    ...
                    <!--<label class="control-label" for="input-customer">Customer</label>-->
                    <input name="filter_customer" value="<?php echo $filter_user; ?>" size="40" placeholder="Search By userid,name,email,last view date" id="input_customer" class="form-control" autocomplete="off" type="text">
                  </div>
