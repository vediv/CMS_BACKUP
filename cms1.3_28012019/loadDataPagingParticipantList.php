...
$total_participants = $totalpages[0]['num'];
?>
<div class="box-header" >
   ...
   <td width="20%" align="center">
      <span class="label label-success">Total Participants<span class="badge" style="color: #337ab7; background-color: #fff;padding: 0px 4px 1px 4px;"><?php echo $total_participants; ?></span></span>
    </td>
    <td width="30%">
