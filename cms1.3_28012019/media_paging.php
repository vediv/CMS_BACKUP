    ...
    break;
     ...
     break;
      case "save_currency_metadata":
          ...
          $premium_type=($_POST['premium_type']); $is_premium=($_POST['is_premium']);
       ...
       $queryupdate="update entry set currency_data='$customCurrencyInsert',ispremium='$is_premium',planid='$premium_type' where entryid='$entryID' ";
       $upd =db_query($conn,$queryupdate);
       if($upd){
            /*----------------------------update log file begin-------------------------------------------*/
