...
<?php
break;
case "viewParticipantDetail":
  $userid=$_REQUEST['userid'];
	$query1="select * from user_registration where uid='".$userid."'";
  $fetch= db_select($conn,$query1);
  $uname =$fetch[0]['name']; $user_id =$fetch[0]['userid']; $uemail =$fetch[0]['uemail'];  $dob =$fetch[0]['dob'];
 ...
 ?>
   <div class="modal-body">
         ...
         <span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
         <h4 class="modal-title" id="myModalLabel"> <b>Participant Detail - <?php echo $uname; ?> </b></h4>
         </div>
         <br/>
       <div class="row">
            <div class="col-xs-12">
