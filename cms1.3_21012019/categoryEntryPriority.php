...
$qryCat="select planid from category_plan_info where categoryid='$catid'";
                ...
                <div class="box-header">
                  ...
                  <div class="form-group ">
                   ...
                   <?php
                    ...
                    ?>
                    <select name="planid" id="planid" style="width: 370px;" class="form-control" >
                  ...
                  <div>
                    <label for="email">Plan Category Status:</label>
                      <select name="plan_c" id="plan_c" style="width: 370px;" class="form-control">
                          <option  value="premium" <?php echo $plan_c=='premium'?"selected":''; ?>>Premium</option>
                          <option value="free" <?php echo $plan_c=='free'?"selected":''; ?>>Free</option>
                      </select>
                   </div><br /><br />
                   <div>
...
function savePlanCategory(act,pageindex,limitval){
     ...
     $.ajax({
      ...
      data :"categoryid="+categoryid+"&planid="+planid+"&categoryaction="+act+"&pageNum="+pageindex+"&limitval="+limitval,
