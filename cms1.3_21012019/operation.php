...
case "participantlist":
     ...
     $SQL = "SELECT dt.RegCode,dt.name,ur.mobile,dt.regDate,ur.ucountry,ur.dob FROM
...
$html .= '<table border="1"  width="100%" style="border-collapse: collapse; font-family: arial, sans-serif; font-size:11px;">';
//$html .='<tr><td colspan="6" align="center"><b>REGISTERED USERS LIST</b></td></tr>';
$html .= '<tbody><tr><td><b>Sno</b></td><td><b>Reg Code</b></td><td><b>Name</b></td><td><b>Mobile</b></td><td><b>Register Date</b></td><td><b>Country</b></td> <td><b>DOB</b></td> </tr>';
$i=1;
