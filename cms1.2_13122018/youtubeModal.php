...
$searchInputall=isset($_POST['searchInputall'])?$_POST['searchInputall']:''; $ptag=isset($_POST['ptag'])?$_POST['ptag']:''                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ;
$entryId = $Entryid;
$selEntry="select name,duration from entry where entryid='$Entryid' and type='8' and status!='3'";
$f= db_select($conn,$selEntry);
$name=$f[0]['name']; $duration=$f[0]['duration'];
...
function contentPartner(eid,pindex,limitval,searchInputall)
{
    ...
    var dataString = 'Entryid='+eid+"&pageindex="+pindex+'&limitval='+ limitval+"&searchInputall="+searchInputall; 
     $.ajax({
       type: "POST",
       url: "ycontentPartnerMetaData.php",
       data: dataString,
       cache: false,
       success: function(r){
...
function ContentViewer(eid,pindex,limitval,searchInputall)
{
    ...
    var dataString = 'Entryid='+eid+"&pageindex="+pindex+'&limitval='+ limitval+"&searchInputall="+searchInputall; 
     $.ajax({
       type: "POST",
       url: "ycontentViewerMetadata.php",
       data: dataString,
       cache: false,
       success: function(r){
              $("#metadata").html('');$("#thumb").html('');  $("#access_control").html('');$("#currency").html('');
...
function ageRestriction(eid,pindex,limitval,searchInputall)
{
    ...
    var dataString = 'Entryid='+eid+"&pageindex="+pindex+'&limitval='+ limitval+"&searchInputall="+searchInputall; 
     $.ajax({
       type: "POST",
       url: "yAgeRestrictedMetadata.php",
       data: dataString,
       cache: false,
       success: function(r){
              $("#metadata").html('');$("#thumb").html('');  $("#access_control").html('');$("#currency").html('');
