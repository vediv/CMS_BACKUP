...
$entryId = $Entryid;
$selEntry=" select * from entry where entryid='$Entryid' and type='8' and status!='3'";
$f= db_select($conn,$selEntry);
$name=$f[0]['name'];$thumbnailUrl=$f[0]['thumbnail']; $tag=$f[0]['tag']; $description=$f[0]['longdescription'];
$categoriesIds=$f[0]['categoryid']; $duration=$f[0]['duration']; $mdeitype=$f[0]['type']=='8'?'Youtube Video':'';
$created_at=$f[0]['created_at'];$Creator=$f[0]['puser_id'];
...
<div class="pull-right" id="drawVideoPlayer11"  style="border:1px solid #c7d1dd ; width: 40%; margin-right: 5px; padding:5px; height: 400px;">
    <iframe width="350" height="250" src="https://www.youtube.com/embed/<?php echo $entryId;  ?>" allowfullscreen></iframe>
    <p> <strong>Creator </strong>  : <?php echo $Creator; ?></p>
    <p><strong>Created on :</strong> <?php echo gmdate("d/m/y", $created_at); ?></p>
    <hr/>
