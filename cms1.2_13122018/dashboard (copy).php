           ...
           $count =db_totalRow($conn,$results);   
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text" title="Total Active User">Total Active User</span>
                    <span class="info-box-number"><a href="#" class="href_class"><small><?php echo $totalactive==''?"0":$totalactive; ?></small></a></span>
                  <span class="info-box-text" title="Total Inactive User">Total Inactive User</span>
           ...
           <?php  if(in_array(38,$otherPermission)) { ?>
            <div class="col-md-3 col-sm-5 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-users"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text" title="Total Subscription">Total Subscription</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text" title="Total Subscription">Subscription</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text" title="Total Revenue"><strong>Total Revenue</strong></span>
              ...
              <script type='text/javascript'>
                 ...
                 function getTranscodedVideoInfo(acti)
                 {
                    ...
                    $("#actcount_loader,#actdur_loader,#inactcount_loader,#inactdur_loader,#delcount_loader,#deldur_loader,#total_video_loader,#vlength_loader").fadeIn(100).html('<img src="img/image_process.gif" height="20" />');
                        ...
                        url:'coreData.php',
                        dataType: "json",
                        data:{show:acti,month:month,year:year,action:'transcoded_video_info'},
                        success:function(r){
                        if(r.status == 1){
