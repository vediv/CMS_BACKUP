...
<?php  if(in_array(21, $otherPermission)){ ?>
  ...
  <?php
    ...
    $catplanid=$fetcCatinfo[0]['categoryid'];$catTag=$fetcCatinfo[0]['tag'];
    if($directSubCategoriesCount=='0'){
    if($catplanid==$id){
    if($catTag=='p'){ $pbutton='disabled'; $fbutton=''; $bsuccess='btn-success'; $bdanger='btn-danger';   }
    if($catTag=='f'){ $pbutton=''; $fbutton='disabled'; $bsuccess='btn-danger'; $bdanger='btn-success';}
    ?>
<div class="btn-group btn-toggle " style=" position: relative; magin-top:3px;">
<button type="button" <?php echo $pbutton; ?>   title="Premium" onclick="categoryPremiumFree('<?php echo $id; ?>','<?php echo $page; ?>','<?php echo $pagelimit; ?>','p','<?php echo $searchTextMatch;?>')" class="btn btn-xs <?php echo $bsuccess; ?>">P</a>
<button type="button" <?php echo $fbutton; ?> title="Free" onclick="categoryPremiumFree('<?php echo $id; ?>','<?php echo $page; ?>','<?php echo $pagelimit; ?>','f','<?php echo $searchTextMatch;?>')"  class="btn btn-xs <?php echo $bdanger; ?>">F</a>
</div> <?php } } }?>
</td> <?php } ?>
